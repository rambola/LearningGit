...
import com.android.keyguard.LAWMOUtility;
...
public class KeyguardViewMediator extends SystemUI {
    ...
    // XP5: OMA DM LAWMO
    private boolean mIsLAWMOLocked;
    ...
    KeyguardUpdateMonitorCallback mUpdateCallback = new KeyguardUpdateMonitorCallback() {
        ...
        // XP5: OMA DM LAWMO
        @Override
        public void onLAWMOLockStateChanged(boolean isLocked) {
            synchronized (KeyguardViewMediator.this) {
                mIsLAWMOLocked = isLocked;
                ...
                if (DEBUG) Log.d(TAG, "LAWMO lock state changed");
                if (!mShowing) {
                    doKeyguardLocked(null);
                } else {
                    resetStateLocked();
        ...
        public void onSimStateChanged(int subId, int slotId, IccCardConstants.State simState) {
            ...
            // XP5: OMA DM LAWMO
            boolean simPinSecure = mUpdateMonitor.isSimPinSecure() || mIsSubsidyOrDeviceLocked || mIsLAWMOLocked;
    ...
    private void setupLocked() {
        ...
        // XP5: OMA DM LAWMO
        mIsLAWMOLocked = LAWMOUtility.shouldShowLAWMOLock(mContext);
        ...
        synchronized (this) {
            ...
            try {
                ...
                callback.onSimSecureStateChanged(mUpdateMonitor.isSimPinSecure()
                        || mIsSubsidyOrDeviceLocked || mIsLAWMOLocked);
