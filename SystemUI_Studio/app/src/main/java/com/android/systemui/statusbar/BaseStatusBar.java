...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    public void start() {
        ...
        // XP5: Recents
        if (enableCustomRecents(mContext)) {
            mRecents = getComponent(com.android.systemui.recent.Recents.class);
        } else {
            mRecents = getComponent(com.android.systemui.recents.Recents.class);
    ...
    /**
     * XP5: Recents
     * Verify if custom UI is enabled
     */
    private boolean enableCustomRecents(Context context) {
        if (context != null) {
            return context.getResources().getBoolean(R.bool.config_enableCustomRecents);
        }
        return false;
    }
