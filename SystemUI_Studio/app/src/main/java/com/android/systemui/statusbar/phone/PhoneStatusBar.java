...
import com.android.systemui.NotificationFilterListener;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    protected static StatusBarIconController mIconController;
    ...
    private void updateNotificationShade() {
        ...
        for (int i=0; i<N; i++) {
            ...
            if(NotificationFilterListener.mPackageList != null) {
//                if(("true").equalsIgnoreCase(SystemProperties.get("persist.sys.mcl_mode","false")) && (!(NotificationFilterListener.mPackageList.contains(ent.notification.getPackageName()) || ent.notification.getPackageName().contentEquals("android") || ent.notification.getPackageName().contentEquals("com.sonim.borqs.launcher")))) {
                if(NotificationFilterListener.mPackageList.size() > 0 && (!(NotificationFilterListener.mPackageList.contains(ent.notification.getPackageName()) || ent.notification.getPackageName().contentEquals("android") || ent.notification.getPackageName().contentEquals("com.sonim.borqs.launcher")))) {
                    continue;
                }
            }
    ...
    protected void updateNotifications() {
        Log.e(TAG, "........updateNotifications is called..............");
    ...
    protected int adjustDisableFlags(int state) {
        ...
        if (!mLaunchTransitionFadingAway && !mKeyguardFadingAway
            ...
            if (!KeyguardConstants.isDeviceNonTouchAnd12Key(mContext)) {
                state |= StatusBarManager.DISABLE_NOTIFICATION_ICONS;
                state |= StatusBarManager.DISABLE_SYSTEM_INFO;
            } else {
                // XP5: Modifications for * key lock
                // show all icons except clock on lockscreen statusbar
                state |= StatusBarManager.DISABLE_CLOCK;
            }
        }
...
//        if(("false").equalsIgnoreCase(SystemProperties.get("persist.sys.mcl_mode","false"))) {
        if(NotificationFilterListener.mPackageList.size() < 1){
    ...
    private void showOperatorName() {
        ...
        final boolean enableOperatorName = (mContext.getResources().
                getBoolean(com.android.internal.R.bool.config_showOperatorNameInStatusBar));
        // As per AT&T req, <CDR-ONS-195> Network name should always be displayed.
        if (mContext.getResources().getBoolean(com.android.internal.R.bool.config_product_att) ||
                mContext.getResources().
                getBoolean(com.android.internal.R.bool.config_product_southernl)) {
