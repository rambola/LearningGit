...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener,
    ...
    // XP5: Non-touch support
    // Alpha set to 50%. Same as launcher wallpaper background
    private static final float NON_TOUCH_SCRIM_IN_FRONT_ALPHA = 0.5f;
    ...
    private float getScrimInFrontAlpha() {
        ...
        return mKeyguardUpdateMonitor.needsSlowUnlockTransition()
                ...
                : NonTouchUtils.isDeviceNonTouchAnd12Key(mScrimBehind.getContext())
                ? NON_TOUCH_SCRIM_IN_FRONT_ALPHA
