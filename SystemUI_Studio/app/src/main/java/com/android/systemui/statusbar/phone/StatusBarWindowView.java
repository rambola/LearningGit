...
public class StatusBarWindowView extends FrameLayout {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        // XP5: OMA DM LAWMO
        // In case of LAWMO do not allow key functions except for call button, which will be used
        // for invoking emergency.
        if (LAWMOUtility.shouldShowLAWMOLock(mContext)
