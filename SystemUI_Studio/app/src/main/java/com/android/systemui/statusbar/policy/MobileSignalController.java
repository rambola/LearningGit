...
public class MobileSignalController extends SignalController<
    ...
    private boolean isRoaming() {
        // AT&T req, <CDR-ONS-200> No roaming icons should be displayed for AT&T.
    ...
    private final void updateTelephony() {
        ...
        if (mCurrentState.connected) {
            if (!mSignalStrength.isGsm() && mConfig.alwaysShowCdmaRssi) {
                ...
                // AT&T req, <CDR-RBP-1030> No need of getAlternateLteLevel for AT&T and SL.
                if (mConfig.showRsrpSignalLevelforLTE && !mIsCarrierOneNetwork &&
                        !mContext.getResources().getBoolean
                        (com.android.internal.R.bool.config_product_att) &&
                        !mContext.getResources().getBoolean
                        (com.android.internal.R.bool.config_product_southernl)) {
    ...
    private void generateIconGroup() {
        ...
        if (mIsDataSignalControlEnabled) {
            ...
            // Do not show wifi and RAT icons together
